...
enum class ResortStatus(val value: kotlin.String) : com.mtnmanager.sdk.infrastructure.UnknownCaseCheckable {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is ResortStatus) "$data" else null

        /**
         * Returns a valid [ResortStatus] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): ResortStatus? = data?.let {
