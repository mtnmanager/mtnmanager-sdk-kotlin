...
data class TrailMapStaticElementOneOf2 (

    @SerialName(value = "type")
    val type: TrailMapStaticElementOneOf2.Type,
    ...
    @SerialName(value = "terrain_park_uuid")
    val terrainParkUuid: kotlin.String,
