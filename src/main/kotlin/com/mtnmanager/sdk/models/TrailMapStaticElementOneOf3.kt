 ...
 * @param uuid 
 * @param points 
 * @param summerTrailUuid 
 * @param tension 
 */
@Serializable

data class TrailMapStaticElementOneOf3 (

    @SerialName(value = "type")
    val type: TrailMapStaticElementOneOf3.Type,
    ...
    @SerialName(value = "summer_trail_uuid")
    val summerTrailUuid: kotlin.String,
